...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.username_entry.setStyleSheet("text-align: right;")
        self.username_entry.setLayoutDirection(Qt.RightToLeft)
        ...
        self.password_entry.setStyleSheet("text-align: right;")
        self.password_entry.setLayoutDirection(Qt.RightToLeft)
